# ============================================================
# admet_model.py
# ADMET Multi-Model Classification Module
# ============================================================
# Trains seven classifiers + Voting Ensemble for hERG II inhibition prediction.
# Returns best model and cross-validation metrics for integration with main.py.
# ============================================================
...
# ------------------------------------------------------------
def train_admet_models(data_path, out_dir):
    """
    Train and evaluate multiple ADMET classification models for hERG II inhibition.
    Returns (best_model, metrics_dict).
    Saves the final visualization in out_dir.
    """
    ...
    if best_model is not None:
        ...
        plt.tight_layout()
        plot_path = os.path.join(out_dir, "admet_barplot.png")
